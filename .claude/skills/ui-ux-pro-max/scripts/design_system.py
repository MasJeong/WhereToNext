...
def project_slug_for_name(project_name) -> str:
    return str(project_name or "default").strip().lower().replace(" ", "-")
...
def persist_design_system(design_system: dict, page: str = None, output_dir: str = None, page_query: str = None) -> dict:
    ...
    project_slug = project_slug_for_name(project_name)
...
def format_master_md(design_system: dict) -> str:
    ...
    lines.append("")
    project_slug = project_slug_for_name(project)
