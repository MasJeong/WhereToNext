...
export function RecommendationCard({
  ...
  return (
    <article
      ...
      style={revealStyle}
    >
      <div className="compass-result-card compass-card-settle rounded-[var(--radius-card)] px-3.5 py-3.5 sm:px-4 sm:py-4">
        <div className="flex flex-col gap-3 border-b border-[color:var(--color-stage-divider)] pb-3.5">
          ...
          <div className="grid gap-3 lg:grid-cols-[minmax(0,1.08fr)_minmax(15rem,0.92fr)] lg:items-start">
            <div className="space-y-2.5">
              <div>
                <p className="compass-editorial-kicker">TOP {index + 1}</p>
                <h2 className="mt-1.5 font-display text-[1.22rem] leading-[0.96] tracking-[-0.04em] text-[var(--color-ink)] sm:text-[1.48rem]">
                  {destination.nameKo}
                </h2>
            ...
            <section className="compass-story-note rounded-[calc(var(--radius-card)-10px)] px-4 py-4">
              ...
              <p className="mt-2 font-display text-[1rem] leading-tight tracking-[-0.02em] text-[var(--color-ink)]">
                {verdict.headline}
              </p>
        ...
        <div className="mt-3.5 grid gap-3 lg:grid-cols-[minmax(0,1.08fr)_minmax(16rem,0.92fr)] lg:items-start">
          <div className="compass-compact-stack-lg">
            <section className="compass-section-block">
              <p className="compass-editorial-kicker">핵심 정보</p>
              <div className="compass-fact-grid-compact mt-2.5">
            ...
            <section data-testid={getInstagramVibeTestId(index)} className="compass-section-block">
              <p className="compass-editorial-kicker">분위기 근거</p>
              <div className="compass-result-source-strip mt-2.5 rounded-[calc(var(--radius-card)-10px)] px-4 py-4">
          ...
          <aside className="compass-compact-stack">
            ...
            <section className="compass-warning-card rounded-[calc(var(--radius-card)-10px)] px-4 py-4">
