...
function IntentChip({ preset, active, onSelect }: IntentChipProps) {
  return (
    <button
      ...
      className={`shrink-0 rounded-full px-4 py-2.5 text-left ${
        active
          ? "compass-selected shadow-[0_14px_32px_rgb(37_99_235_/_0.16)]"
              ...
              <div className="border-t border-[color:var(--color-frame-soft)] pt-3">
                ...
                {showAdvancedFilters ? (
                  ...
                  >
                      ...
                      <div className="space-y-2.5">
                        <p className="text-xs font-semibold tracking-[0.08em] text-[var(--color-sand-deep)]">출발 월</p>
                        <div className="flex flex-wrap gap-2">
                          {travelMonthOptions.map((option) => (
                            <button
                              ...
                              className={`rounded-full px-3 py-2 text-xs font-semibold tracking-[0.04em] ${
                                query.travelMonth === option.value ? "compass-selected" : "compass-selection-chip"
                              }`}
                            >
                              {option.label}
                            </button>
                      ...
                      <div className="space-y-2.5">
                        <p className="text-xs font-semibold tracking-[0.08em] text-[var(--color-sand-deep)]">대표 분위기</p>
                        <div className="flex flex-wrap gap-2">
                          {primaryVibeOptions.map((option) => (
                            <button
                              ...
                              className={`rounded-full px-3 py-2 text-xs font-semibold tracking-[0.04em] ${
                                query.vibes[0] === option.value ? "compass-selected" : "compass-selection-chip"
                              }`}
                            >
                              {option.label}
                            </button>
                      ...
                      <div className="space-y-2.5">
                        <p className="text-xs font-semibold tracking-[0.08em] text-[var(--color-sand-deep)]">출발 공항</p>
                        <div className="flex flex-wrap gap-2">
                      ...
                      <div className="space-y-2.5">
                        <p className="text-xs font-semibold tracking-[0.08em] text-[var(--color-sand-deep)]">일정 밀도</p>
                        <div className="flex flex-wrap gap-2">
                      ...
                      <div className="space-y-2.5">
                        <p className="text-xs font-semibold tracking-[0.08em] text-[var(--color-sand-deep)]">비행 부담</p>
                        <div className="flex flex-wrap gap-2">
                      ...
                      <div className="space-y-2.5">
                        <p className="text-xs font-semibold tracking-[0.08em] text-[var(--color-sand-deep)]">보조 분위기</p>
                        <div className="flex flex-wrap gap-2">
